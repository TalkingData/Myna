...
public abstract class MynaRecognizerInterface {
     ...
     */
    public MynaRecognizerInterface(ClassifierInterface classifier, MynaResultCallback resultCallback){
        ...
        dataFusionHandler = new Handler();
        recognitionHandler = new Handler();
